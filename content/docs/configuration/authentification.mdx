...
<Callout type="note" twClass="mt-0">
  The auth part is similar at the [authjs](https://authjs.dev/) documentation. You can follow the
...
<Callout type="danger" twClass="mt-3">
  After upgrade Auth.js to v5: `NEXTAUTH_URL` has removed from `.env` file. Same thing **in
  production**.
</Callout>
