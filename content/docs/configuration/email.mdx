...
<Callout type="warning" twClass="mt-2.5">
  However, you can't test it on this demo app because I don't want to use the premium Resend plan
  for this demo.
</Callout>
...
<Callout type="note">
  The email part is similar at the [resend](https://resend.com/) documentation. You can find the
  official documentation [here](https://authjs.dev/getting-started/installation#setup-environment)
  if you want.
</Callout>
